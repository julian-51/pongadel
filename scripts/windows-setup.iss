#define MyAppName "Easy Pong"
#define MyAppPublisher "Julian Kristal Sejahtera"
#define MyAppPublisherURL "mailto:juliankristal51@gmail.com"
#define MyAppURL "https://github.com/adeeteya/EasyPong"
#define MyAppExeName "easy_pong.exe"
#define MyAppContact "juliankristal51@gmail.com"
#define MyAppCopyright "Copyright (C) 2026 Julian Kristal Sejahtera"
#define Workspace GetEnv("GITHUB_WORKSPACE")

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{EC0CD638-ECC8-4A05-B784-EC6EEB6D77D6}
AppName={#MyAppName}
